...
public class GraphAlgo {
    ...
    private HashMap<String, VertexAlgo> vertices;
    private HashMap<Integer, EdgeAlgo> edges;
    
    public GraphAlgo(){
        this.vertices = new HashMap<String, VertexAlgo>();
        this.edges = new HashMap<Integer, EdgeAlgo>();
    }
     ...
     */
    public GraphAlgo(ArrayList<VertexAlgo> vertices){
        this.vertices = new HashMap<String, VertexAlgo>();
        this.edges = new HashMap<Integer, EdgeAlgo>();
        
        for(VertexAlgo v: vertices){
     ...
     */
    public boolean addEdge(VertexAlgo one, VertexAlgo two){
     ...
     */
    public boolean addEdge(VertexAlgo one, VertexAlgo two, int weight){
        if(one.equals(two)){
            return false;   
        }
       
        //ensures the Edge is not in the Graph
        EdgeAlgo e = new EdgeAlgo(one, two, weight);
     ...
     */
    public boolean containsEdge(EdgeAlgo e){
     ...
     */
    public EdgeAlgo removeEdge(EdgeAlgo e){
     ...
     */
    public boolean containsVertex(VertexAlgo vertex){
     ...
     */
    public VertexAlgo getVertex(String label){
     ...
     */
    public boolean addVertex(VertexAlgo vertex, boolean overwriteExisting){
    	VertexAlgo current = this.vertices.get(vertex.getLabel());
        if(current != null){
     ...
     */
    public VertexAlgo removeVertex(String label){
    	VertexAlgo v = vertices.remove(label);
     ...
     */
    public Set<EdgeAlgo> getEdges(){
        return new HashSet<EdgeAlgo>(this.edges.values());
    }
